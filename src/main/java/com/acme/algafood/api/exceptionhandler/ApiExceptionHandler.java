...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
        ...
        private ResponseEntity<Object> handleInvalidFormat(InvalidFormatException ex, HttpHeaders headers,
                ...
                String detail = String.format(
                                "A propriedade '%s' recebeu o valor '%s' " + "que é de um tipo inválido. Corrija "
        ...
        private ResponseEntity<Object> handlePropertyBinding(PropertyBindingException ex, HttpHeaders headers,
                ...
                String detail = String
                                .format("A propriedade '%s' não existe. " + "Corrija ou remova essa propriedade " +
        ...
        public ResponseEntity<?> handleNoHandlerException(Exception ex, WebRequest request) {
        ...
        // .build();
        // return
        // ResponseEntity.status(HttpStatus.UNSUPPORTED_MEDIA_TYPE).body(problema);
        // }
        ...
        protected ResponseEntity<Object> handleExceptionInternal(Exception ex, @Nullable Object body,
                ...
                if (body == null) {
                        ...
                        body = Problem.builder().status(status.value()).title(body.toString())
                                        .userMessage(MSG_ERRO_GENERICA_USUARIO_FINAL)
                                        .build();
                }
        ...
        private Problem.ProblemBuilder createProblemBuilder(HttpStatus status, ProblemType problemType, String detail) {
                return Problem.builder().status(status.value()).title(problemType.getTitle())
                                .detail(detail).type(problemType.getUri()).timestamp(OffsetDateTime.now());
        }

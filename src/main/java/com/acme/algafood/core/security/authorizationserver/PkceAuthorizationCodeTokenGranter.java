...
public class PkceAuthorizationCodeTokenGranter extends AuthorizationCodeTokenGranter {
	...
	@SuppressWarnings("deprecation")
    public PkceAuthorizationCodeTokenGranter(@SuppressWarnings("deprecation") AuthorizationServerTokenServices tokenServices,
			@SuppressWarnings("deprecation") AuthorizationCodeServices authorizationCodeServices, @SuppressWarnings("deprecation") ClientDetailsService clientDetailsService,
			@SuppressWarnings("deprecation") OAuth2RequestFactory requestFactory) {
		super(tokenServices, authorizationCodeServices, clientDetailsService, requestFactory);
	}

	@SuppressWarnings("deprecation")
    @Override
	protected OAuth2Authentication getOAuth2Authentication(@SuppressWarnings("deprecation") ClientDetails client, @SuppressWarnings("deprecation") TokenRequest tokenRequest) {
		@SuppressWarnings("deprecation")

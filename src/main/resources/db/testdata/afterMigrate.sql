...
insert into usuario (id, nome, email, senha, data_cadastro) values (5, 'Debora Mendonça', 'setval42+debora@gmail.com', '$2a$12$.XsfnCZqm5gFb3EeeY3sGOMFJxh4GeX.XLUA.2mdO2eYjvepOch1S', utc_timestamp);
insert into usuario (id, nome, email, senha, data_cadastro) values (6, 'Carlos Lima', 'setval42+carlos@gmail.com', '$2a$12$.XsfnCZqm5gFb3EeeY3sGOMFJxh4GeX.XLUA.2mdO2eYjvepOch1S', utc_timestamp);
...
values (1, 'a62afc68-d97e-4a2a-afe5-65945e8341eb', 1, 5, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'Brasil',
...
insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep, 
        endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
        status, data_criacao, subtotal, taxa_frete, valor_total)
values (2, '5dd30c36-55e8-42a8-996d-6123a5a538dc', 4, 6, 2, 1, '38400-111', 'Rua Acre', '300', 'Casa 2', 'Centro',
